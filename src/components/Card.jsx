...
const Card = (props) => {
  ...
  return (
    <div className="bg-white bg-[url('/src/assets/cardtexture.png')] bg-cover px-2 py-1 max-w-[110px] mr-[-30px]  rounded-[10px] drop-shadow-3xl font-LibreBaskerville  text-2xl">
